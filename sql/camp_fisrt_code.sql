...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`car_item_` (
...
INSERT INTO camping_company (company_id, company_name, company_address, company_phone, company_oner, company_oner_email) VALUES ('1', 'Company1', 'Address1', '010-6549-3690', 'Owner1', 'owner1@example.com');
